const page = () => {
  return (
    <main>
      <div>
        <h3 className="text-center text-4xl font-extrabold uppercase tracking-wider">
          Privacy Policy
        </h3>
        <article className="z container ml-auto mr-auto flex flex-col gap-4 p-10 text-justify text-lg leading-8">
          <p>
          ...
          <p>
            ...
            accessing or using the Service, as applicable. Company (referred to
            as either “the Company”, “We”, “Us” or “Our” in this Agreement)
            refers to upupapp.xyz
          </p>
          <p>
            ...
            authority. Account means a unique account created for You to access
            our Service or parts of our Service.
          </p>
          <p>
            Website refers to upupapp.xyz, accessible from upupapp.xyz Service
            refers to the Website. Country refers to: India Service Provider
          ...
          <p>
            Necessary / Essential CookiesType: Session Cookies Administered by
            ...
            Acceptance CookiesType: Persistent CookiesAdministered by:
            UsPurpose: These Cookies identify if users have accepted the use of
            cookies on the Website. Functionality CookiesType: Persistent
          ...
          <p>
            ...
            of our Service. To manage Your Account: to manage Your registration
          ...
          <p>
            ...
            Service may see You name, profile, pictures and description of Your
